...
public class ZkServerListCell extends JFXListCell<ServerConfigurationVO> {
    ...
    public ZkServerListCell(Consumer<ServerConfigurationVO> connectAction,
        ...
        JFXButton connectButton = new JFXButton(connectText);
        ...
        JFXButton deleteButton = new JFXButton(deleteText);
        ...
        JFXButton disconnectButton = new JFXButton(disconnectText);
    ...
    protected void updateItem(ServerConfigurationVO item, boolean empty) {
        ...
        if (empty || item == null) {
            ...
            ImageView symbolImage = new ImageView("assets/img/connected-symbol.png");
